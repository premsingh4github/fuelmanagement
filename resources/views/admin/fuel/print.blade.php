    ...
    <div class="page">
        <div class="subpage" >
            <form class="mce-content-body">
                ...
                <h2 style="text-align: center;"> Official Fuel</h2>
                <?php $fuel = $entry; ?>
                <table>
                    <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><strong>{{config('custom.nepali_months')[$fuel->month_id]}}</strong></td>
                    </tr>
                    <tr>
                    ...
                    @foreach($fuel->fuel_services as $service)
                        <tr>
                            <td><strong>{{$service->vehicle_service->service->name}} </strong></td>
                            <td><strong>{{$service->quantity}}</strong></td>
                        </tr>
                    @endforeach
                    <tr>
                        <td><strong>Receiver Name</strong></td>
                        <td><strong>{{$fuel->receiver->name}}</strong></td>
                    </tr>
